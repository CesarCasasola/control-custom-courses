				    			...
				    			<div class="modal-content">
				    				...
				    				<form class="form-vertical" method="POST" action="upCurso.php">
				    					<div class="modal-body form-group">
				    						...
				    						<label class"control-label col-sm-2">Nombre del Curso: </label><input class="form-control" required name="nombre" id="nombre-'.$registroCurso['idcurso'].'" value="'.$registroCurso['nombre'].'" /></br>
				    						<label class"control-label col-sm-2">Descripción: </label><input class="form-control" required name="descripcion" id="descripcion-'.$registroCurso['idcurso'].'" value="'.$registroCurso['descripcion'].'" /></br>											
